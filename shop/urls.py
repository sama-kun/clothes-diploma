...
urlpatterns = [
    ...
    path('generate_pdf/', generate_pdf.generate_pdf, name='generate_pdf'),
    ...
    path("deletefromcart/<int:prid>/<str:sizeId>", cartoperations.deletefromcart, name="DeletefromCart"),
    path("deleteallfromcart/<int:prid>/<str:sizeId>", cartoperations.deleteallfromcart, name="DeleteAllfromCart"),
